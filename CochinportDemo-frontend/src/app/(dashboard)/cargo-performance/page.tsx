...
import CargoTrendChart from "@/components/cargoPerformance/TrendOfCargoVolumeChart"
import TopCommoditiesChart from "@/components/cargoPerformance/TopCommodities"
...
export default function CargoPerformance() {
    /* const dummyData = [
        {
                  ...
                  <>
                   ...
                   {/* Three-dot button */}
                              <div className="relative ms-auto">
                                ...
                                {dropdownOpen && (
                                  <div className="absolute right-0 mt-2 w-40 bg-white border border-gray-600 rounded shadow-lg z-50 me-2">
                                    <button
            ...
            <div className="flex-1 overflow-y-auto  px-5 py-4 space-y-2 ">
                <div className="grid grid-cols-10 gap-4">
                    ...
                    <div className="col-span-6 pl-4">
                        <CargoTrendChart startDate={startDate} endDate={endDate} />
                    </div>

                    {/* Top commodities takes 30% width */}
                    <div className="col-span-4">
                        <TopCommoditiesChart startDate={startDate} endDate={endDate}/>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-10 gap-4">
                    ...
                    <div className="pl-4 col-span-6" >
                        <ContainerTrafficTrendChart startDate={startDate} endDate={endDate} />
                    </div>
                    <div className="col-span-4">
                         <CargoShareChart startDate={startDate} endDate={endDate}/>
                  </div>
                </div> 
            </div>
        </div>
